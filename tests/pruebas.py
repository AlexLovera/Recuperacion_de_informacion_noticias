...
# #         #     print(titulo.text)
# # imprimir_titulos()
# # from Indice_invertido_y_compresion import revertir_saltos_docID,_generar_saltos_docID,Variable_byte_encode_number
# # from Indice_invertido_y_compresion import Variable_byte_encode_list,Variable_byte_decode_list
# # #PARA QUE CORRA ESTO HAY QUE MODIFICAR _generar_saltos_docID... y que no decodifique la posting list
# # supuesto_indice_sin_compresion={1:[7,25,43,104,105],2:[100,130,145,155,156,191]}
# # indice_con_salto=_generar_saltos_docID(supuesto_indice_sin_compresion)
# # print("Indice con salto: ",indice_con_salto)
# # print("indice_SIN_salto,primer lista: ",revertir_saltos_docID(indice_con_salto[1]))
# # print("indice_SIN_salto,segunda lista: ",revertir_saltos_docID(indice_con_salto[2]))
# #
# # indice_con_salto_codificado_primer_lista=Variable_byte_encode_list(indice_con_salto[1])
# # print("indice_con_salto_codificado: ",indice_con_salto_codificado_primer_lista)
# # print("indice_con_salto_DEcodificado: ",Variable_byte_decode_list(indice_con_salto_codificado_primer_lista))
#
#
# def x():
#     contador=1
#     for bloque in range(0,32,2):
#         print(f"iteracion :{contador} n°bloque: {bloque} y bloque+1: {bloque+1}")
#         contador+=1
#     for y in range(1,5):
#         print(y)
# x()
from TP2EDD_Ultimas_pruebas.Indice_invertido_y_compresion import *
from TP2EDD_Ultimas_pruebas.Crear_indice_post_list import *
posting_list=[10,15,26,100,102,220,221]
codificador=UncompressedPostings()
indice={1000:codificador.encode(posting_list)}
#genero saltos en DocId
indice_con_saltos=generar_saltos_docID(indice)
print("posting list: ",posting_list)
print("indice SIN saltos: ",indice)
print("indice CON saltos: ",indice_con_saltos)
print("posting list: ",posting_list)
# print("posting list ")
#comprimo la lista con VB
lista_comprimida=Variable_byte_encode_list(indice_con_saltos[1000])
print("posting list comprimida con VB: ",lista_comprimida)
#ahora descomprimo para obtener la posting list
lista_descomprimida=Variable_byte_decode_list(lista_comprimida)
posting_list_descomprimida=revertir_saltos_docID(lista_descomprimida)
print("indice y post, con saltos: ",indice_con_saltos)
print("posting list: ",posting_list)
print("posting list descomprimida y saltos revertidos: ",posting_list_descomprimida)
